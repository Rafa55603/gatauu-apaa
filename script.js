...
hilang1.addEventListener('click', function(){
  alert('Huruf depan kamu kan A tau ga artinya? A itu artinya aku sayang kamu xixixi. Awan, awan apa yang bikin seneng? Awanna be with you AHAHAHA, APAAN SI DARI KEMAREN GOMBALAN DARI GOOGLE CRINGE SEMUAA NJERR gausa dipikirin gombalanya pikirin yang ngirim ajaaa ahaha:>');
})
